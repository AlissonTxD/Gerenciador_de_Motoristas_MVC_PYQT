class ModelRegister:
    def register(self, name: str, plate: str, type: str, data: list):
        try:
    ...
    def __validate_fields(self, name: str, plate: str, type: str):
    ...
    def __verify_availability(self, information: dict, data: list):
        for driver in data:
            if driver["name"] == information["name"]:
                raise Exception (f"Este Nome Já Esta Cadastrado\nNome: {driver['name']}\nPlaca: {driver['plate']}")
            elif driver["plate"] == information["plate"]:
                raise Exception (f"Esta Placa Já Esta Cadastrada\nNome: {driver['name']}\nPlaca: {driver['plate']}")
